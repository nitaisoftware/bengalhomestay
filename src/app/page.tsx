          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/host/register" className="bg-yellow-500 hover:bg-yellow-400 text-white px-6 py-3 rounded-full font-bold transition-all shadow-lg">
                  List for Free →
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">West Bengal&apos;s most trusted homestay directory. Connecting travellers with authentic local experiences since 2024.</p>
            </div>
            <div>
